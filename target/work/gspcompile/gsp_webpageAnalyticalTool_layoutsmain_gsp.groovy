...
createTagBody(2, {->
printHtmlPart(23)
invokeTag('message','g',92,['code':("application.crawlerTools.label"),'default':("Web crawling")],-1)
printHtmlPart(24)
createTagBody(3, {->
invokeTag('message','g',93,['code':("crawlerSession.label"),'default':("Crawler Session")],-1)
})
invokeTag('link','g',93,['controller':("crawlerSession")],3)
printHtmlPart(25)
invokeTag('message','g',95,['code':("application.dbTools.label"),'default':("Database definition")],-1)
printHtmlPart(24)
createTagBody(3, {->
invokeTag('message','g',96,['code':("DBField.label"),'default':("Database Field")],-1)
})
invokeTag('link','g',96,['controller':("DBField")],3)
printHtmlPart(26)
createTagBody(3, {->
invokeTag('message','g',97,['code':("DBPlugin.label"),'default':("Database Plugin")],-1)
})
invokeTag('link','g',97,['controller':("DBPlugin")],3)
printHtmlPart(27)
invokeTag('message','g',99,['code':("application.biTools.label"),'default':("Business Intelligence")],-1)
printHtmlPart(24)
createTagBody(3, {->
invokeTag('message','g',100,['code':("BIDimension.label"),'default':("Dimension")],-1)
})
invokeTag('link','g',100,['controller':("BIDimension")],3)
printHtmlPart(26)
createTagBody(3, {->
invokeTag('message','g',101,['code':("BIMeasure.label"),'default':("Measure")],-1)
})
invokeTag('link','g',101,['controller':("BIMeasure")],3)
printHtmlPart(28)
createTagBody(3, {->
invokeTag('message','g',102,['code':("BISchemaTemplate.label"),'default':("Schema Template")],-1)
})
invokeTag('link','g',102,['controller':("BISchemaTemplate")],3)
printHtmlPart(29)
expressionOut.print(grailsApplication.config.bisystem.link)
printHtmlPart(30)
invokeTag('message','g',103,['code':("application.accessSaiku.label"),'default':("Go to Saiku")],-1)
printHtmlPart(31)
invokeTag('message','g',109,['code':("application.backgroundprocesses.label"),'default':("Background Processes")],-1)
printHtmlPart(32)
invokeTag('message','g',114,['code':("application.runningCrawlers.label"),'default':("Running Crawlers")],-1)
printHtmlPart(33)
...
printHtmlPart(35)
createTagBody(3, {->
invokeTag('message','g',121,['code':("application.backgroundprocesses.forceDBE.label"),'default':("Force-execute DB Expander")],-1)
})
invokeTag('link','g',121,['controller':("SystemStatus"),'action':("launchExpander"),'params':([targetUri: (request.forwardURI - request.contextPath)])],3)
printHtmlPart(36)
})
...
public static final long LAST_MODIFIED = 1403788638000L
